...
| --------- | --------------- | ------------ | --------- |
| rack2 | Vlan4094 | 192.168.99.5 | Port-Channel1 |
...
| Ethernet2 | MLAG_PEER_leaf4_Ethernet2 | *trunk | *2-4094 | *- | *['MLAG'] | 1 |
| Ethernet3 | SPINE1_Ethernet4 | *trunk | *none | *- | *- | 3 |
| Ethernet4 | SPINE2_Ethernet4 | *trunk | *none | *- | *- | 3 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4094 |  default  |  192.168.99.4/31  |  -  |  -  |  -  |  -  |  -  |
