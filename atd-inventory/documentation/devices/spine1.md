...
| --------- | --------------- | ------------ | --------- |
| SPINES | Vlan4094 | 192.168.99.1 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_spine2_Ethernet1 | *trunk | *2-4094 | *- | *['MLAG'] | 1 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_spine2_Po1 | switched | trunk | 2-4094 | - | ['MLAG'] | - | - | - | - |
